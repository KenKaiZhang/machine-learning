...
class AuxClassifiers(nn.Module):
...
class GoogLeNet(nn.Module):
    def __init__(self, aux, dropout, aux_dropout, num_classes):
        ...
        self.conv2a = Conv(64, 192, kernel_size=3, stide=1, padding=2)
        ...
        self.inception4a = Inception(512, 192, 96, 208, 16, 48, 64)
        ...
        self.aux1 = AuxClassifiers(512, num_classes, aux_dropout) if aux else None
        self.aux2 = AuxClassifiers(528, num_classes, aux_dropout) if aux else None
